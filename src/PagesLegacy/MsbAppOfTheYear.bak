...
const MsbAppOfTheYear = () => {
return (
<>
  <Helmet>
    <title>Brit Fintech Awards | MSB App of the Year</title>
    <meta name="description" content="" />
    <meta name="keywords" content="MSB App of the Year, Payment Payout Innovations, Fintech Awards, Financial Services Innovations" />
    <meta property="og:title" content="Brit Fintech Awards | MSB App of the Year" />
    <meta property="og:description" content="" />
    <meta property="og:image" content="https://britfintechawards.com/assets/img/aword/MSB/MSB-App-of-the-Year.png" />
  </Helmet>
    ...
    <div className="row" >
      <div className="col-lg-5" >
        <div className="cs-icon_box cs-style7 text-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s"
          ...
          <img src="../assets/img/aword/MSB/MSB-App-of-the-Year.png"
            style={{ boxShadow: "3px 0 10px 0 #b3b3b3",borderRadius:'20px' }} alt="MSB App of the Year" />
        </div>
          ...
          <div className="cs-vertical_middle_in" >
            <div className="cs-text_box cs-style1 cs-size1 wow fadeIn p-4" data-wow-duration="1s" data-wow-delay="0.3s"
              ...
              <ul className="cs-text_box_list cs-mp0 cs-primary_color">
                ...
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  Applicants must have FCA licence.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  The app must be live and available to users for at least one year prior to the nomination deadline.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  The app must comply with all applicable laws and regulations, including anti-money laundering (AML) and counter-terrorism financing (CTF) requirements.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
           ...
           <RegisterButton awardName="MSB App of the Year" />
          </div>
        </div>
      </div>
...
export default MsbAppOfTheYear