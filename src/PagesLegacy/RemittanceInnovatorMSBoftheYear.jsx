...
const RemittanceInnovatorMSBoftheYear = () => {
return (
<>
  <Helmet>
    <title>Brit Fintech Awards | Remittance Innovator MSB of the Year</title>
    <meta name="description"
      content="Recognizing innovation and excellence in remittance solutions for Money Service Businesses (MSBs) within the financial technology sector." />
    <meta name="keywords"
      content="Remittance Innovator MSB of the Year, MSB Remittance Solutions, Fintech Awards, Financial Services Remittances" />
    <meta name="author" content="Your Organization Name" />
    <meta property="og:title" content="Brit Fintech Awards | Remittance Innovator MSB of the Year" />
    <meta property="og:description"
      content="Recognizing innovation and excellence in remittance solutions for Money Service Businesses (MSBs) within the financial technology sector." />
    <meta property="og:image" content="https://britfintechawards.com/assets/img/aword/MSB/Remittance-Innovator-MSB.png" />
  </Helmet>
    ...
    <div className="container wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s" style={{
      ...
      <div className="cs-hero_text text-left">
        <h1 className="cs-hero_title cs-white text-uppercase pb-3 mb-0" style={{ marginTop: "40px !important" }}>
          <strong>Remittance Innovator</strong> <br /> MSB of the year
        </h1>
    ...
    <div className="row" bis_skin_checked={1}>
      <div className="col-lg-5" bis_skin_checked={1}>
        <div className="cs-icon_box cs-style7 text-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s"
          ...
          <img src="../assets/img/aword/MSB/Remittance-Innovator-MSB.png"
            style={{ boxShadow: "3px 0 10px 0 #b3b3b3",borderRadius:'20px' }} alt="Remittance Innovator MSB of the year" />
        </div>
          ...
          <div className="cs-vertical_middle_in" bis_skin_checked={1}>
            <div className="cs-text_box cs-style1 cs-size1 wow fadeIn p-4" data-wow-duration="1s" data-wow-delay="0.3s"
              ...
              <ul className="cs-text_box_list cs-mp0 cs-primary_color">
                ...
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  The applicant must be a registered company with a valid license and operational status.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  Applicants must explain innovation in remittance services, such as technology advancements, service delivery models.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
            ...
            <RegisterButton awardName="Remittance Innovator MSB of the Year" />
          </div>
        </div>
      </div>
...
export default RemittanceInnovatorMSBoftheYear;