...
const BestinCustomerServiceMSBoftheYear = () => {
return (
<>
  <Helmet>
    <title>Brit Fintech Awards | Best in Customer Service MSB of the Year</title>
    <meta name="description"
      content="Recognizing the MSB providing exceptional customer service and support within the financial technology sector." />
    <meta name="keywords"
      content="Best in Customer Service MSB of the Year, MSB Customer Service Excellence, Fintech Awards, Financial Services Customer Support" />
    <meta name="author" content="Your Organization Name" />
    <meta property="og:title" content="Brit Fintech Awards | Best in Customer Service MSB of the Year" />
    <meta property="og:description"
      content="Recognizing the MSB providing exceptional customer service and support within the financial technology sector." />
    <meta property="og:image" content="https://britfintechawards.com/assets/img/aword/MSB/Best-in-Customer-Service-MSB.png" />
  </Helmet>
    ...
    <div className="container wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s" style={{
      ...
      <div className="cs-hero_text text-left">
        <h1 className="cs-hero_title cs-white text-uppercase pb-3 mb-0" style={{ marginTop: "40px !important" }}>
          <strong>Best in Customer Service</strong> <br /> MSB of the year
        </h1>
    ...
    <div className="row" bis_skin_checked={1}>
      <div className="col-lg-5" bis_skin_checked={1}>
        <div className="cs-icon_box cs-style7 text-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s"
          ...
          <img src="../assets/img/aword/MSB/Best-in-Customer-Service-MSB.png"
            style={{ boxShadow: "3px 0 10px 0 #b3b3b3",borderRadius:'20px' }} alt="Best in Customer Service MSB of the year" />
        </div>
          ...
          <div className="cs-vertical_middle_in" bis_skin_checked={1}>
            <div className="cs-text_box cs-style1 cs-size1 wow fadeIn p-4" data-wow-duration="1s" data-wow-delay="0.3s"
              ...
              <ul className="cs-text_box_list cs-mp0 cs-primary_color">
                ...
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  Applicants must demonstrate excellence in customer service and provide evidence through customer feedback, testimonials, or performance metrics.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  Unique offers implemented to attract new customers and retain existing ones should comply with UK rules and regulations.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
             ...
             <RegisterButton awardName="Best in Customer Service MSB of the Year" />
          </div>
        </div>
      </div>
...
export default BestinCustomerServiceMSBoftheYear;