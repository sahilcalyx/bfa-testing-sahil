...
const PayOutInnovatoroftheYear = () => {
return (
<div>
  <Helmet>
    <title>Brit Fintech Awards | Pay-Out Innovator of the Year</title>
    <meta name="description"
      content="Recognizing excellence in pay-out solutions and innovations within the financial technology sector." />
    <meta name="keywords"
      content="Pay-Out Innovator of the Year, Payment Payout Innovations, Fintech Awards, Financial Services Innovations" />

    <meta property="og:title" content="Brit Fintech Awards | Pay-Out Innovator of the Year" />
    <meta property="og:description"
      content="Recognizing excellence in pay-out solutions and innovations within the financial technology sector." />
    <meta property="og:image" content="https://britfintechawards.com/assets/img/aword/Fintech/Pay-Out-Innovator-of-the-Year.png" />
  </Helmet>
    ...
    <div className="container wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s" style={{
      ...
      <div className="cs-hero_text text-left">
        <h1 className="cs-hero_title cs-white text-uppercase pb-3 mb-0" style={{ marginTop: "40px !important" }}>
          <strong>Pay-Out Innovator</strong> <br /> of the year
        </h1>
        <p className="pb-0 mb-0 text-left" style={{color:'#00FFFF'}}>
        Praising the champions of innovation in pay-out methods.
        </p>
    ...
    <div className="row">
      <div className="col-lg-5">
        <div className="cs-icon_box cs-style7 text-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s"
          ...
          <img src="../assets/img/aword/Fintech/Pay-Out-Innovator-of-the-Year.png"
            style={{ boxShadow: "3px 0 10px 0 #b3b3b3",borderRadius:'20px' }} alt="Pay-Out Innovator of the year" />
        </div>
          ...
          <div className="cs-vertical_middle_in">
            <div className="cs-text_box cs-style1 cs-size1 wow fadeIn p-4" data-wow-duration="1s" data-wow-delay="0.3s"
              ...
              <ul className="cs-text_box_list cs-mp0 cs-primary_color">
                ...
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  The award is open to companies, organisations, or individuals demonstrating exceptional innovation in the field of payout solutions.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  Eligible innovations must relate to payout processes, technologies, or systems implemented within the past 12 months.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
            ...
            <RegisterButton awardName="Pay-Out Innovator of the Year" />
          </div>
        </div>
      </div>
...
export default PayOutInnovatoroftheYear;