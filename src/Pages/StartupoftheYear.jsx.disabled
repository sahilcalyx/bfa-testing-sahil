...
const StartupoftheYear = () => {
return (
<div>
  <Helmet>
    <title>UK Startup of the Year 2024 | Brit Fintech Award 2024</title>
    <meta name="description"
      content="Discover the Start Up of the Year 2024 at the Fintech Awards UK. Celebrate the most innovative fintech startups driving change in the finance industry." />
    <meta name="keywords" content="Startup of the Year, Fintech Startups, Emerging Fintech, Innovation Awards" />

    <meta property="og:title" content="UK Startup of the Year 2024 | Brit Fintech Award 2024" />
    <meta property="og:description"
      content="Discover the Start Up of the Year 2024 at the Fintech Awards UK. Celebrate the most innovative fintech startups driving change in the finance industry." />
    <meta property="og:image" content="https://britfintechawards.com/assets/img/aword/Fintech/Startup-of-the-Year.png" />
  </Helmet>
    ...
    <div className="container wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s" style={{
      ...
      <div className="cs-hero_text text-left">
        <h1 className="cs-hero_title cs-white text-uppercase pb-3 mb-0" style={{ marginTop: "40px !important" }}>
          <strong>Startup</strong> <br /> of the year
        </h1>
    ...
    <div className="row" bis_skin_checked={1}>
      <div className="col-lg-5" bis_skin_checked={1}>
        <div className="cs-icon_box cs-style7 text-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s"
          ...
          <img src="../assets/img/aword/Fintech/Startup-of-the-Year.png"
            style={{ boxShadow: "3px 0 10px 0 #b3b3b3",borderRadius:'20px' }} alt="Startup of the year" />
        </div>
          ...
          <div className="cs-vertical_middle_in" bis_skin_checked={1}>
            <div className="cs-text_box cs-style1 cs-size1 wow fadeIn p-4" data-wow-duration="1s" data-wow-delay="0.3s"
              ...
              <ul className="cs-text_box_list cs-mp0 cs-primary_color">
                ...
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  The startup should have been in operation for no more than 3 years from the date of application submission.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  Participation is open to startups from Fintech and MSB Sector.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
            ...
            <RegisterButton awardName="Startup of the Year" />
...
export default StartupoftheYear;