...
const ProgressiveMoneyExchangerMSBoftheYear = () => {
const [isRedirecting, setIsRedirecting] = useState(false);

const handleClick = () => {
setIsRedirecting(true);
// You can add additional logic here, such as setting a timeout to simulate the redirect
setTimeout(() => {
// Redirect logic goes here
window.location.href =
"/nominate-now?awardId=Progressive Money Exchanger MSB of the Year";
}, 1000); // Redirect after 1 second (1000 milliseconds)
};
return (
<>
  <Helmet>
    <title>Brit Fintech Awards | Progressive Money Exchanger MSB of the Year</title>
    <meta name="description"
      content="Recognizing the most innovative and progressive money exchanger within Money Service Businesses (MSBs) in the financial technology sector." />
    <meta name="keywords"
      content="Progressive Money Exchanger MSB of the Year, MSB Money Exchanger Innovations, Fintech Awards, Financial Services Money Exchange" />

    <meta property="og:title" content="Brit Fintech Awards | Progressive Money Exchanger MSB of the Year" />
    <meta property="og:description"
      content="Recognizing the most innovative and progressive money exchanger within Money Service Businesses (MSBs) in the financial technology sector." />
    <meta property="og:image" content="https://britfintechawards.com/assets/img/aword/MSB/Progressive-Money-Exchanger-MSB.png" />
  </Helmet>
  ...
  <div className="cs-hero cs-style12 cs-type1 cs-center text-center  cs-parallax cs-hobble" style={{
    ...
    <div className="container wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s" style={{
      ...
      <div className="cs-hero_text text-left">
        ...
        <p className="pb-0 mb-0 text-left" style={{color:'#00FFFF'}}>
    ...
    <div className="row" bis_skin_checked={1}>
      <div className="col-lg-5" bis_skin_checked={1}>
        <div className="cs-icon_box cs-style7 text-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s"
          ...
          <img src="../assets/img/aword/MSB/Progressive-Money-Exchanger-MSB.png"
            style={{ boxShadow: "3px 0 10px 0 #b3b3b3",borderRadius:'20px' }} alt="Progressive Money Exchanger MSB of the year" />
        </div>
          ...
          <div className="cs-vertical_middle_in" bis_skin_checked={1}>
            <div className="cs-text_box cs-style1 cs-size1 wow fadeIn p-4" data-wow-duration="1s" data-wow-delay="0.3s"
              ...
              <ul className="cs-text_box_list cs-mp0 cs-primary_color">
                ...
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  Applicants must showcase their innovative products, services, or technologies that have contributed to the advancement of the Fintech/MSB industry.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
            ...
            <RegisterButton awardName="Progressive Money Exchanger MSB of the Year" />
          </div>
        </div>
      </div>
...
export default ProgressiveMoneyExchangerMSBoftheYear;