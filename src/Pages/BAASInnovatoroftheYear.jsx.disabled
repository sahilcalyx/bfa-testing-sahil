...
const BAASInnovatoroftheYear = () => {
return (
<div>
  <Helmet>
    <title>Brit Fintech Awards | B-A-A-S Innovator of the Year</title>
    <meta name="description"
      content="Recognizing innovation and excellence in Banking-as-a-Service solutions within the fintech industry." />
    <meta name="keywords"
      content="B-A-A-S Innovator of the Year, Banking-as-a-Service Innovations, Fintech Awards, Financial Services Innovations" />
    ...
    <div className="container wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s" style={{
      ...
      <div className="cs-hero_text text-left">
        <h1 className="cs-hero_title cs-white text-uppercase pb-3 mb-0" style={{ marginTop: "40px !important" }}>
          <strong>B-A-A-S Innovator</strong> <br /> of the year
        </h1>
    ...
    <div className="row" bis_skin_checked={1}>
      ...
      <div className="col-lg-7" bis_skin_checked={1}>
        <div className="cs-vertical_middle" bis_skin_checked={1}>
          <div className="cs-vertical_middle_in" bis_skin_checked={1}>
            <div className="cs-text_box cs-style1 cs-size1 wow fadeIn p-4" data-wow-duration="1s" data-wow-delay="0.3s"
              ...
              <ul className="cs-text_box_list cs-mp0 cs-primary_color">
                ...
                <li>
                  <i className="fas fa-check cs-accent_color" /> Applicants must have a registered business and operational presence in the UK.
                </li>
              </ul>
         ...
         <RegisterButton awardName="B-A-A-S Innovator of the Year" />
          </div>
        </div>
      </div>
...
export default BAASInnovatoroftheYear;