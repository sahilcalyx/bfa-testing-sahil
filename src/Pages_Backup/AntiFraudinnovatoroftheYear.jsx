...
const AntiFraudinnovatoroftheYear = () => {
return (
<>
  <Helmet>
    <title>Brit Fintech Awards | Anti-Fraud Innovator of the Year</title>
    <meta name="description"
      content="Recognizing excellence and innovation in anti-fraud technologies and solutions within the financial technology sector." />
    <meta name="keywords"
      content="Anti-Fraud Innovator of the Year, Fraud Prevention Innovations, Fintech Awards, Financial Services Security" />
    <meta name="author" content="Your Organization Name" />
    <meta property="og:title" content="Brit Fintech Awards | Anti-Fraud Innovator of the Year" />
    <meta property="og:description"
      content="Recognizing excellence and innovation in anti-fraud technologies and solutions within the financial technology sector." />
    <meta property="og:image" content="https://britfintechawards.com/assets/img/aword/Fintech/Anti-Fraud-Innovator-of-the-Year.png" />
  </Helmet>
    ...
    <div className="container wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s" style={{
      ...
      <div className="cs-hero_text text-left">
        <h1 className="cs-hero_title cs-white text-uppercase pb-3 mb-0" style={{ marginTop: "40px !important" }}>
          <strong> Anti-Fraud Innovator</strong> <br /> of the year
        </h1>
    ...
    <div className="row" bis_skin_checked={1}>
      <div className="col-lg-5" bis_skin_checked={1}>
        <div className="cs-icon_box cs-style7 text-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s"
          ...
          <img src="../assets/img/aword/Fintech/Anti-Fraud-Innovator-of-the-Year.png"
            style={{ boxShadow: "3px 0 10px 0 #b3b3b3",borderRadius:'20px' }} alt=" Anti-Fraud Innovator of the year" />
        </div>
          ...
          <div className="cs-vertical_middle_in" bis_skin_checked={1}>
            <div className="cs-text_box cs-style1 cs-size1 wow fadeIn p-4" data-wow-duration="1s" data-wow-delay="0.3s"
              ...
              <ul className="cs-text_box_list cs-mp0 cs-primary_color">
                ...
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  The innovation must have been implemented within the last two years as of the nomination date.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
           ...
           <RegisterButton awardName="Anti-Fraud Innovator of the Year" />
          </div>
        </div>
      </div>
  ...
  <div className="cs-height_120 cs-height_lg_120" />A
</>
);
};

export default AntiFraudinnovatoroftheYear;