...
import TeeparamTestimonialsSlider from "./TeeparamTestimonialsSlider";
...
const TeeparamExchangeDetails2025 = () => {
  return (
    ...
    >
      <Helmet>
        <title>
          Teeparam Exchange: Award-Winning Fintech Excellence | Brit Fintech
          Awards 2025
        </title>
        <meta
          name="description"
          content="Mercury Danati offers trusted currency exchange in London with award-winning compliance, competitive rates, and over 80 currencies at 3 key locations."
        />
        <meta
          name="keywords"
          content="Mercury Danati, London currency exchange, currency exchange specialist, foreign exchange London, MSB London, money service business UK, competitive exchange rates, over 80 world currencies, travel money exchange, currency exchange for businesses, Brit Fintech Awards 2024, award-winning compliance, secure currency exchange, transparent exchange rates, trusted FX provider London"
        />
        <meta name="author" content="Brit Fintech Award" />
        <meta
          property="og:title"
          content="Teeparam Exchange: Award-Winning Fintech Excellence | Brit Fintech Awards 2025"
        />
        <meta
