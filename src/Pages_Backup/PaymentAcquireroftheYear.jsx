...
const PaymentAcquireroftheYear = () => {
return (
<>
  <Helmet>
    <title>Brit Fintech Awards | Payment Acquirer of the Year</title>
    <meta name="description"
      content="Recognizing the top payment acquirer for excellence and innovation in the financial technology sector." />
    <meta name="keywords"
      content="Payment Acquirer of the Year, Payment Processing Innovations, Fintech Awards, Payment Solutions" />
    <meta property="og:title" content="Payment Acquirer of the Year" />
    <meta property="og:description"
      content="Recognizing the top payment acquirer for excellence and innovation in the financial technology sector." />
    <meta property="og:image" content="https://britfintechawards.com/assets/img/aword/Fintech/Payment-Acquirer-of-the-Year.png" />
  </Helmet>
    ...
    <div className="container wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s" style={{
      ...
      <div className="cs-hero_text text-left">
        <h1 className="cs-hero_title cs-white text-uppercase pb-3 mb-0" style={{ marginTop: "40px !important" }}>
          <strong> Payment Acquirer</strong> <br /> of the year
        </h1>
    ...
    <div className="row" >
      <div className="col-lg-5" >
        <div className="cs-icon_box cs-style7 text-center wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s"
          ...
          <img src="../assets/img/aword/Fintech/Payment-Acquirer-of-the-Year.png"
            style={{ boxShadow: "3px 0 10px 0 #b3b3b3",borderRadius:'20px' }} alt=" Payment Acquirer of the year" />
        </div>
      ...
      <div className="col-lg-7" >
        <div className="cs-vertical_middle" >
          <div className="cs-vertical_middle_in" >
            <div className="cs-text_box cs-style1 cs-size1 wow fadeIn p-4" data-wow-duration="1s" data-wow-delay="0.3s"
              ...
              <ul className="cs-text_box_list cs-mp0 cs-primary_color">
                ...
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  Applicants must demonstrate a track record of financial stability and consistent growth over the past two years.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
                  Applicants must showcase their innovative products, services or technologies that have contributed to the advancement of the fintech industry.
                </li>
                <li>
                  <i className="fas fa-check cs-accent_color" />
          ...
          <RegisterButton awardName="Payment Acquirer of the Year" />
          </div>
        </div>
      </div>
...
export default PaymentAcquireroftheYear;