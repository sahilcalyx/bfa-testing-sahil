...
<>
  <Helmet>
    <title>Brit Fintech Awards | MSB of the Year</title>
    <meta name="description" content="" />
    <meta name="keywords"
      content="MSB of the Year, Payment Payout Innovations, Fintech Awards, Financial Services Innovations" />

    <meta property="og:title" content="Brit Fintech Awards | MSB of the Year" />
    <meta property="og:description" content="" />
    <meta property="og:image" content="https://britfintechawards.com/assets/img/aword/Globle/msb-of-year.png" />
  </Helmet>
    ...
    <div className="container wow fadeInDown" data-wow-duration="1s" data-wow-delay="0.2s" style={{
      ...
      <div className="cs-hero_text text-left">
        <h1 className="cs-hero_title cs-white text-uppercase pb-3 mb-0" style={{ marginTop: "40px !important" }}>
          <strong>MSB</strong> <br />of the year
        </h1>
