...
const VENUE_ADDRESS = "122 Leadenhall St, London EC3V 4AB";
        ...
        {!isExpanded && (
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2 sm:translate-x-0 sm:left-auto sm:bottom-6 sm:right-6 md:bottom-8 md:right-8 z-30 pointer-events-auto w-[calc(100%-2rem)] sm:w-[290px]">
            <style>{`
              ...
              .card-section-interactive.section-venue {
                cursor: pointer;
                text-decoration: none;
                color: inherit;
              }
              ...
              .card-section-interactive.section-venue:hover {
            ...
            >
              <div className="venue-card-inner">
                ...
                <a
                  ...
                  className="card-section-interactive section-venue"
                ...
                >
                  ...
                  <div className="flex flex-col items-start text-left min-w-0 flex-1">
                    ...
                    <span className="vc-address">{VENUE_ADDRESS}</span>
                  </div>
                </a>
