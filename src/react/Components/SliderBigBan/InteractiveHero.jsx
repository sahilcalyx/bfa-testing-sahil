  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-screen lg:h-[100svh] flex flex-col lg:flex-row overflow-hidden bg-black text-white font-outfit select-none">
        ...
        <div className={`relative bg-black flex flex-col justify-center overflow-hidden transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] z-10 ${
          isExpanded 
            ? "w-0 lg:w-0 h-0 lg:h-full min-h-0 lg:min-h-0 p-0 opacity-0 pointer-events-none" 
            : "w-full lg:w-1/2 min-h-[50vh] lg:min-h-0 pt-28 pb-12 px-6 md:p-12 lg:p-16 opacity-100"
        }`}>
          ...
          <div className={`flex-1 flex flex-col justify-center items-center text-center my-12 lg:my-0 z-10 max-w-lg mx-auto transition-all duration-500 ${
            ...
            <motion.p
              ...
              className="text-white/90 text-sm sm:text-base md:text-lg font-normal tracking-wide mt-6 mb-8 font-montserrat max-w-sm"
            >
        ...
        <div 
          ...
          className={`relative overflow-hidden bg-zinc-950 flex flex-col justify-center transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] z-20 ${
            isExpanded 
        ...
        >
          ...
          <video
            ...
            src={isExpanded ? "/assets/video/bfa-banner-video.mp4" : "/assets/video/bfa-banner-videood.mp4"}
            autoPlay
            loop={!isExpanded}
            muted={!isExpanded}
            playsInline
            controls={isExpanded}
            poster="/assets/img/event-conference/bfa_video_thumbnail.png"
          />

          {/* Vignette & color filter overlay */}
          <div className={`absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-black/50 z-0 pointer-events-none transition-opacity duration-700 ${
            isExpanded ? "opacity-0" : "opacity-100"
          }`} />

          {/* Central Play Button Interaction */}
          <div className={`flex-1 flex items-center justify-center z-10 transition-all duration-500 ${
          ...
          >
            ...
            >
              <video
                ...
                src="/assets/video/bfa-banner-video.mp4"
                autoPlay
                controls
                playsInline
              />
