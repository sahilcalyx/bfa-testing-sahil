...
const highlights = [
  ...
  },
  {
    icon: Zap,
    title: "13+ Currencies",
    desc: "Multi-currency trading",
  },
  {
    icon: Users,
    title: "20,000+ Businesses",
    desc: "Onboarded worldwide",
  },
  {
    icon: ShieldCheck,
    title: "800,000+ Transactions",
    desc: "Processed seamlessly",
  },
];
...
const keyFeatures = [
  {
    ...
    desc: "Hold, receive, and manage funds across multiple currencies from one connected, centralized platform.",
  },
  {
    icon: Zap,
    title: "International Transfers & Pay-outs",
    desc: "Fast, reliable global payouts and cross-border money movements across 21+ countries and 13+ trading currencies.",
  },
  {
    icon: CreditCard,
    title: "Collections & Payment Links",
    desc: "Accept payments effortlessly with versatile payment links and flexible collection solutions built for merchants and PSPs.",
  },
  {
    icon: Layers,
    title: "Card Payments Infrastructure",
    desc: "Seamless card processing capabilities integrated into your business workflow for frictionless global transactions.",
  },
  {
    icon: Building2,
    title: "Built for All Business Scales",
    desc: "Serving start-ups, SMEs, enterprises, merchants, payment service providers, and financial institutions.",
  },
  {
    icon: Sparkles,
    title: "Connected & Accessible Operations",
    desc: "Simplifying international financial operations so businesses can expand across markets with ease and compliance.",
  },
];

const LeatherbackSponsorDetails2026 = () => {
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900 font-['Outfit',system-ui,sans-serif]">
      ...
      <div className="mx-auto w-full max-w-4xl px-4 md:px-6 pt-5 pb-12 md:py-14">
        ...
        {/* Connected Global Financial Operations */}
        <section className="mb-14 rounded-2xl border-l-[4px] border-[#c8102e] bg-white p-6 md:p-8 shadow-[0_4px_20px_rgba(15,23,42,0.04)]">
          <div className="flex items-center gap-2.5 mb-3">
            ...
            <h2 className="m-0 text-[22px] md:text-[26px] font-extrabold tracking-tight text-zinc-950">
              Connected &amp; Accessible Global Finance
            </h2>
          </div>
        ...
        <section className="mb-14">
          <div className="text-center mb-8">
            ...
            <h2 className="mt-2 text-[24px] md:text-[30px] font-extrabold tracking-tight text-zinc-950">
              Solutions Spanning Accounts, Payments &amp; Pay-outs
            </h2>
          </div>
...
export default LeatherbackSponsorDetails2026;
