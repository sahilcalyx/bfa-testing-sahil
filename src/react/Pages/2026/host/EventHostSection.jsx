...
const EventHostSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main Content Grid (Top Layer) */}
      <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-10 items-start max-w-7xl w-full mx-auto mb-4 md:mb-6">
        ...
        >
          <div className="relative w-full z-[10]">
            ...
            {/* Prominent Circular CTA Button - High z-index [40] to float above marquee text */}
            <div className="absolute right-3 bottom-12 sm:right-4 sm:bottom-6 md:right-[-16px] lg:right-[-20px] md:top-1/2 md:-translate-y-1/2 md:bottom-auto z-[40]">
              <motion.div
              ...
              >
                <Link 
                  ...
                  className="w-20 h-20 sm:w-22 sm:h-22 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-[#c8102e] to-[#800010] text-white flex flex-col items-center justify-center border-2 border-white/30 shadow-[0_10px_25px_rgba(200,16,46,0.7),0_0_0_3px_rgba(200,16,46,0.3)] hover:from-[#e61435] hover:to-[#c8102e] transition-all duration-300 cursor-pointer block"
                >
                  <span className="font-extrabold text-[10px] sm:text-[11px] md:text-[12px] tracking-wider text-center leading-tight uppercase drop-shadow-sm">
                    VIEW
                    <br />
                    PROFILE
                  </span>
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-4 md:h-4 mt-0.5 mx-auto" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
      ...
      <div className="relative -mt-20 sm:-mt-28 md:-mt-36 lg:-mt-44 pointer-events-none select-none overflow-hidden">
        ...
        {/* Row 2: FRONT LAYER OVER IMAGE (z-[20]) - Directly Below Row 1 */}
