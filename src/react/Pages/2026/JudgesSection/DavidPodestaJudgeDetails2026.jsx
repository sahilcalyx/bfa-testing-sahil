...
const judgeData = {
  ...
  bioParagraphs: [
    "David's extensive career in the online sector since the early 2000s David has gained valuable high level across diverse industries including <strong>gambling, finance, and online marketplaces</strong>. He has contributed to both major established players and nascent start-ups, operating in both the UK and European markets.",
    "For the past <strong>eight years, David has specialised in day-zero start-ups</strong>, where he has been instrumental in establishing their payment and compliance functions from the ground up. His expertise lies in <strong>building robust and efficient operational frameworks</strong> for new ventures."
  ]
};

const DavidPodestaJudgeDetails2026 = () => {
              ...
              <div className="bg-white border border-zinc-100 rounded-[32px] p-6 md:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.025)] flex flex-col items-center text-center">
                ...
                <div className="w-full space-y-3.5 text-left mb-6">
                  <div className="flex justify-between items-center text-xs">
                    ...
                    <span className="text-zinc-800 font-bold">Trust & Safety (Fraud)</span>
                  </div>
                  <div className="flex justify-between items-center text-xs">
...
export default DavidPodestaJudgeDetails2026;
