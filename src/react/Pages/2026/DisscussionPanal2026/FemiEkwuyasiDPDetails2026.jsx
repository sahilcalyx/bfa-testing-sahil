...
import { femiEkwuyasi } from "./panelists2026";

const speaker = femiEkwuyasi;

const FemiEkwuyasiDPDetails2026 = () => {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={`${speaker.name} is ${speaker.designation} of ${speaker.company} and a discussion panelist at the Brit FinTech Awards 2026.`}
        />
      </Helmet>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12">
            <div className="lg:col-span-4 flex flex-col gap-6">
              <div className="bg-white border border-zinc-100 rounded-[32px] p-6 md:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.025)] flex flex-col items-center text-center sticky top-28">
                ...
                <img
                  src={speaker.logoLight || speaker.logo}
                  alt={speaker.company}
                ...
                {speaker.licensedEntity && (
                  <div className="text-zinc-400 text-[10px] font-extrabold uppercase tracking-[0.16em] mt-1">
                    {speaker.licensedEntity}
                  </div>
                )}
...
export default FemiEkwuyasiDPDetails2026;
