    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      axios
        ...
        .catch((error) => {
          ...
          const errorMessage = error.response?.data?.data || "An error occurred during form submission. Please try again.";
          Swal.fire({
            title: "Error!",
            text: errorMessage,
            icon: "error",
                ...
                <div className="row cs-row_gap_20">
                  ...
                  <div className="col-lg-12">
                    <textarea
                      ...
                      cols={30}
                      rows={5}
                      className={`cs-form_field cs-white_bg cs-accent_30_border cs-primary_color ${errors.message && "error-border"
                        }`}
