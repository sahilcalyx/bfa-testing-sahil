        ...
        <div className="row cs-row_gap_20">
          ...
          <div className="col-sm-6">
            <input
              ...
              id="foundername"
              name="foundername"
              className={`cs-form_field cs-white_bg cs-accent_30_border cs-primary_color undefined ${errors.foundername && "error-border"
                }`}
          ...
          <div className="col-sm-12">
            <textarea
              id="whypitchatbfa"
              name="whypitchatbfa"
              className={`cs-form_field cs-white_bg cs-accent_30_border cs-primary_color undefined ${errors.whypitchatbfa && "error-border"
                }`}
          ...
          <div className="col-sm-12">
            ...
            <input
              ...
              className={`cs-form_field cs-white_bg cs-accent_30_border cs-primary_color undefined ${errors.businessincorporationdate && "error-border"
                }`}
