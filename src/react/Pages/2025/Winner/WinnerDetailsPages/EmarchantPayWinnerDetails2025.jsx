    ...
    <div className="vyne-container-winner25">
        ...
        >
          <div className="row h-100 m-0">
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 d-flex align-items-center justify-content-center text-white">
              ...
              >
                <img
                  src="../assets/img/winners2025-logs-banner/eMerchantPay-winner25-banner.png"
                  style={{
                    width: "100%",
                    height: "100%",
                    objectFit: "cover",
      ...
      <div className="content-winner25">
        <h3>
          ...
          <strong>
            emerchantpay :{" "}
            <span className="text-dark">Payment Acquirer of the Year 2025</span>{" "}
          </strong>
        </h3>
        ...
        <h4 className="mt-4">Key Features of emerchantpay</h4>
        ...
        <h4 className="mt-4">Why emerchantpay Deserves Recognition?</h4>
        <p>
          emerchantpay stands out as a <strong>leader in global payments</strong> by combining innovation, technology, and customer focus. Its achievements include:
        </p>
        <ul>
          <li>Enabling merchants to accept payments seamlessly across <strong>multiple channels and geographies</strong>.</li>
          <li>Offering <strong>bespoke solutions</strong> that enhance business efficiency and profitability.</li>
          <li>Providing robust <strong>fraud prevention and compliance tools</strong>, ensuring secure transactions worldwide.</li>
          <li>Facilitating a superior <strong>customer experience</strong> with fast, reliable, and transparent payment processing.</li>
        </ul>
        <p>
          emerchantpay’s commitment to <strong>innovation, global reach, and merchant empowerment</strong> positions it as an indispensable partner in the payments ecosystem.
        </p>

        <h4 className="mt-4">Conclusion</h4>
        <p>
        emerchantpay has redefined the standards for global payment acquiring—delivering speed, security, and operational excellence across multiple channels. Its focus on technology-driven solutions, risk management, and seamless customer experiences makes <strong>emerchantpay the ideal winner of the Payment Acquirer of the Year Award at the Brit Fintech Awards 2025</strong>.
        </p>
      </div>
...
export default EmarchantPayWinnerDetails2025;
