...
const keynoteData = [
  {
    ...
    keywords:
      "Ochebhoya Ekpete, Leatherback UK, Brit FinTech Awards 2025, keynote speaker, fintech leadership, global payments, financial transformation, MSB sector, Stripe, Interswitch, Cellulant, cross-border finance, UK fintech",
    ...
    fullDesc: `
  <p>
    <strong>Ochebhoya Ekpete</strong> is the CEO of Leatherback, UK, with over 15 years of experience in financial leadership, transformation, and governance.
  </p>

  <p>
    He possesses deep expertise in fintech, payments, and multinational operations, shaped by leadership roles at <strong>Cellulant, Interswitch,</strong> and <strong>Stripe.</strong> 
  </p>

  <p>
   In these positions, he drove initiatives in global financial strategy, commercial pricing, and treasury operations, building systems that enable sustainable growth. 
  </p>

  <p>
    At Leatherback, Ochebhoya leads the UK team in strengthening financial controls, enhancing operational efficiency, and delivering on the company’s long-term vision of seamless global financial mobility.
  </p>
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: "250px" }}>
              ...
              <div className="align-items-center d-flex ">
                <a href="https://leatherback.co/" target="_blank" rel="noopener noreferrer">
                <img
                ...
                <a
                  href="https://www.linkedin.com/in/ochebhoya-ekpete/" // ochebhoya’s LinkedIn
                  target="_blank"
          ...
          {/* Back Button */}
          <button
            onClick={() => navigate("/our-keynote-speaker-2025")}
            style={{
              padding: "10px 20px",
              fontSize: "15px",
              fontWeight: "600",
...
export default OchebhoyaKeyNoteDetails;
