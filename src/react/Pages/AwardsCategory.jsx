...
const   AwardsCategory = () => {
  return (
    <>
      <Helmet>
        <title> Fintech Awards UK 2026 | Financial Awards UK </title>
        <meta
          name="description"
          content="Join our Brit Fintech Awards UK 2026, the leading financial awards in the UK celebrating top innovators and achievements in the fintech industry. "
        />
      </Helmet>
            ...
            >
              <div className="cs-text_box cs-style1 cs-type1 text-center">
                ...
                <div className="row  pb-0 pt-3" style={{ textAlign: "left" }}>
                  <ul
                    className="card card-body mb-0 fs-6"
                    style={{
                      listStyle: "none",
                      fontWeight: "600",
                      lineHeight: "3",
