...
const AWARD_IMG = "/assets/img/aword/2026/Payment-Gateway-of-the-Year.png";

const PaymentGatewayOfTheYear = () => {
  return (
    <>
      <Helmet>
        <title>Brit Fintech Awards | Payment Gateway of the Year</title>
        <meta
          name="description"
          content="Recognising outstanding payment gateway solutions driving the future of digital payments."
        />
        <meta
          name="keywords"
          content="Payment Gateway of the Year, Digital Payments Award, FinTech Awards, Payment Processing, Brit FinTech Awards"
        />
        <meta property="og:title" content="Brit Fintech Awards | Payment Gateway of the Year" />
        <meta
      ...
      >
        ...
        >
          <div className="cs-hero_text text-left">
            ...
            >
              <strong>Payment Gateway</strong> <br /> of the Year
            </h1>
          ...
          <div className="col-lg-5">
            ...
            >
              <img
                ...
                alt="Payment Gateway of the Year"
              />
            </div>
              ...
              <div className="cs-vertical_middle_in">
                ...
                >
                  ...
                  <ul className="cs-text_box_list cs-mp0 cs-primary_color">
                    ...
                    <li>
                      <i className="fas fa-check cs-accent_color" />
                      Applicants must showcase their payment gateway products, services or technologies that have contributed to the advancement of digital payments and the fintech industry.
                    </li>
                    <li>
                      <i className="fas fa-check cs-accent_color" />
                      Applicants should demonstrate secure, reliable and efficient payment processing, supporting seamless transactions for businesses and their customers.
                    </li>
                    <li>
                      <i className="fas fa-check cs-accent_color" />
                ...
                <RegisterButton awardName="Payment Gateway of the Year" />
              </div>
            </div>
          </div>
...
export default PaymentGatewayOfTheYear;
